        ...
        try {
            ...
            if (result.success) {
                ...
                progressInterval = setInterval(async () => {
                    try {
                        const progressResponse = await fetch('http://localhost:8002/api/progress');
            ...
            refreshStatus.textContent = '✗ Failed to connect to scraper API. Make sure api.py is running.';
            setLoading(false);
            progressBar.style.display = 'none';
